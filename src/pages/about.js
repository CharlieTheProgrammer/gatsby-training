        ...
        return (
            <Layout>
                <div className="d-flex flex-column d-sm-block">
                    <h1>About</h1>
                    <Image />
                    <p>Hi, I’m Charlie.<br/><br /> I love learning new things and solving problems. Over the past few years, I’ve fixed everything from cars to software bugs to inefficient business processes. I just can’t help myself. </p>

                    <p>My greatest professional achievements relating to software are my <a href='/portfolio'>TaskTrack.net</a> and <a href='/portfolio'>CreditScale</a> projects. The former is a simple application for keeping track of tasks. The latter is a more complex project that converts data received from an XML API into a JSON based REST API. You can find out more about these projects on my <a href='/portfolio'>portfolio</a> page.</p>
